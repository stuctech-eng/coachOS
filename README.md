...
| Item | Prioriteit |
|------|-----------|
| **🟡 `docs/specialist-api.md` gereconstrueerd (v2.4.71)** — goede-trouw-reconstructie, geen byte-perfecte kopie. Aanbevolen: korte controle-leesbeurt om te bevestigen dat de inhoud overeenkomt met wat destijds is goedgekeurd. | 🟡 |
...
| GitHub tags aanmaken v2.0.4 t/m v2.4.71 | 🟡 |
