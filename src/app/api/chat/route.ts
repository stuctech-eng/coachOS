...
export async function POST(req: NextRequest) {
  try {
    ...
    // Bouw coach context
    const context = [
      `Je bent CoachOS, de persoonlijke AI coach van ${naam}.`,
      `Gedraag je als een echte coach: interpreteer data, vergelijk trends, beslis en leg uit.`,
      `Herhaal NOOIT ruwe data. Geef altijd een persoonlijk, onderbouwd coaching antwoord.`,
      `Antwoord in het Nederlands. Wees direct en concreet. Max 3-4 zinnen tenzij meer gevraagd wordt.`,
      ``,
      `PROFIEL:`,
