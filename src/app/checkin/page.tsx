...
export default function CheckInPage() {
  ...
  const handleSubmit = async () => {
    ...
    setError('')
    try {
      await saveCheckin({ feeling_score: feeling, energy_score: energy, has_pain: hasPain, pain_description: hasPain ? painDesc : undefined, notes: notes || undefined })
      setDone(true)
      ...
      <div className="px-5 py-6 flex flex-col gap-6">
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            ...
            <button type="button" onClick={() => setHasPain(!hasPain)}
          ...
          {hasPain && (
            <textarea placeholder="Omschrijf kort wat je voelt..." value={painDesc} onChange={e => setPainDesc(e.target.value)} rows={2}
        ...
        <Card className="p-4">
          ...
          <textarea placeholder="Optioneel..." value={notes} onChange={e => setNotes(e.target.value)} rows={2}
