...
// geen nieuwe API nodig, andere weergave van dezelfde data.
//
// Bewust EERLIJK over de rolling horizon: weken buiten de komende 1-2
// weken tonen gewoon lege dagen — geen nepdata, geen suggestie van een
// volledig ingevulde maand die er nog niet is.
...
const TYPE_KLEUR: Record<string, string> = {
  duurtraining: 'bg-primary-500',
  lange_duurtraining: 'bg-blue-500',
  interval: 'bg-red-500',
...
export default function TrainingsKalenderPage() {
  ...
  useEffect(() => {
    fetch('/api/specialists/cycling/training-plan', { credentials: 'include' })
      .then(r => r.json())
