...
const SECTIES: Sectie[] = [
  ...
  },
  {
    ...
    intro: 'Naast Coach AI kun je specialisten activeren: coaches die één sport tot in detail kennen. Op dit moment bestaan de Cycling Coach en de Running Coach.',
    inhoud: [
