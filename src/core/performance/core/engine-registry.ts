...
export const ENGINE_REGISTRY: EngineRegistryEntry[] = [
  ...
  { naam: 'Readiness Engine', key: 'readiness', status: 'actief', fase: '1B', omschrijving: 'Recovery + vandaag\'s trainingsplan + CoachPolicy samengevat' },
  ...
  { naam: 'Progress Score', key: 'progress', status: 'actief', fase: '2', omschrijving: '' },
  { naam: 'Climbing Score', key: 'climbing', status: 'actief', fase: '2', omschrijving: '' },
  { naam: 'Sprint Score', key: 'sprint', status: 'actief', fase: '2', omschrijving: '' },
  { naam: 'Efficiency Score', key: 'efficiency', status: 'actief', fase: '2', omschrijving: '' },
